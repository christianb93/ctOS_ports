...
cd build/ncurses
../../src/ncurses-6.0+20160213/configure --disable-database --with-fallbacks=vt100,ctos --includedir=$CTOS_PREFIX/sysroot/usr/include --without-progs --without-tests --without-cxx-binding --without-ada --prefix=$CTOS_PREFIX/install/ --host=i686-pc-ctOS 
make -j 4
